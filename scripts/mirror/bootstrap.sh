...
mkdir -p /var/www/html/repos/theforeman/{releases/1.14/el7/x86_64,plugins/1.14/el7/x86_64}
...
createrepo /var/www/html/repos/theforeman/releases/1.14/el7/x86_64
createrepo /var/www/html/repos/theforeman/plugins/1.14/el7/x86_64
...
#---------
rsync -avz --exclude='repo*' rsync://rsync.theforeman.org/yum/releases/1.14/el7/x86_64/ /var/www/html/repos/theforeman/releases/1.14/el7/x86_64/
rsync -avz --exclude='repo*' rsync://rsync.theforeman.org/yum/plugins/1.14/el7/x86_64/ /var/www/html/repos/theforeman/plugins/1.14/el7/x86_64/
